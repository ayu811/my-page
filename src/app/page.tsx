          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-md overflow-hidden transition transform hover:scale-102">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mt-4 mb-3 text-gray-700">QuantumOpt</h3>
                <p className="text-gray-500 mb-6">
                  An open-source framework for solving optimization problems using quantum annealing techniques...
                </p>
                 {/* タグをシンプルに */}
            ...
            <div className="bg-white rounded-2xl shadow-md overflow-hidden transition transform hover:scale-102">
              ...
              <div className="p-6">
                <span className="px-3 py-1 text-xs font-semibold bg-purple-100 text-purple-600 rounded-full">LLM Optimization</span>
                <h3 className="text-xl font-bold mt-4 mb-3 text-gray-700">QuantumLLM</h3>
                <p className="text-gray-500 mb-6">
                   A research project demonstrating memory footprint reduction for LLM training and inference...
                </p>
                {/* タグをシンプルに */}
                <div className="flex flex-wrap gap-2 mb-6">
                  <span className="px-2 py-1 text-xs bg-gray-200 text-gray-600 rounded-md">PyTorch</span>
                  <span className="px-2 py-1 text-xs bg-gray-200 text-gray-600 rounded-md">CUDA</span>
                  <span className="px-2 py-1 text-xs bg-gray-200 text-gray-600 rounded-md">Transformers</span>
                </div>
               {/* リンクボタンをシンプルに */}
                <div className="flex justify-between items-center">
                  <a href="#" className="text-purple-500 hover:text-purple-600 font-medium">View Project →</a>
                  <div className="flex gap-3">
                      {/* GitHub, Website アイコン */}
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-700">email.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-700">+81-XX-XXXX-XXXX</p>
                  </div>
                </div>
                {/* ソーシャルメディアリンク (アイコンのみ) */}
